...
// POST requests
const joinRoom =
    "${url}notification/join-room-request"; // Endpoint to send a join room request
const signup = "$user/add-user"; // Endpoint to sign up a new user
const addRoommate =
    "$room/add-roommate"; // Endpoint to add a roommate to a room
const createRoom = "$room/create-room"; // Endpoint to create a new room
const leaveRoomWarning =
    "/leave-warning"; //endpoint to get warning associated with leaving a room.
const sendAnnouncementPth =
    "$notification/send-announcement"; //endpoint to send an announcement
const leaveRoomPth = "/leave-room"; //endpoint to leave a room
const getRoommatePth =
    "/get-roommate"; //endpoint to get message whether or not  the user has roommates
